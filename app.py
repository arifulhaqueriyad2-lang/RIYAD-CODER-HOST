...
app = Flask(__name__)
app.secret_key = os.environ.get("SECRET_KEY", "riyad_hosting_secret_key_2024")
...
@app.route('/')
def home():
    return f"<h1> 𝐑𝐈𝐘𝐀𝐃 𝐂𝐎𝐃𝐄𝐑 𝐇𝐎𝐒𝐓𝐈𝐍𝐆 𝐒𝐄𝐑𝐕𝐄𝐑</h1><p>Running at {time.ctime()}</p>"
...
def login():
    ...
    <head>
        ...
        <title>ㅤ𝐑𝐈𝐘𝐀𝐃 𝐂𝐎𝐃𝐄𝐑 𝐇𝐎𝐒𝐓𝐈𝐍𝐆 | Login</title>
        <style>
    ...
    <body>
        ...
        <div class="login-container">
            <div class="logo">ㅤ𝐑𝐈𝐘𝐀𝐃 𝐂𝐎𝐃𝐄𝐑 𝐇𝐎𝐒𝐓𝐈𝐍𝐆</div>
...
if __name__ == "__main__":
    ...
    print(f"""
    ╔══════════════════════════════════════════╗
    ║        𝐑𝐈𝐘𝐀𝐃 𝐂𝐎𝐃𝐄𝐑 𝐇𝐎𝐒𝐓𝐈𝐍𝐆 𝐔𝐍𝐋𝐈𝐌𝐈𝐓𝐄𝐃 𝐒𝐄𝐑𝐕𝐄𝐑    ║
    ║           𝐅𝐑𝐄𝐄 𝐇𝐎𝐀𝐓𝐈𝐍𝐆 𝐒𝐄𝐑𝐕𝐄𝐑            ║
    ╠══════════════════════════════════════════╣
